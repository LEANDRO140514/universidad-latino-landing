...
```ts
const phoneNumber = "529994538421";  // ← Cambia aquí
...
Busca las líneas que contienen `wa.me/529994538421` (aparece 2 veces) y `tel:+529994538421` (aparece 1 vez):
...
Reemplaza `529994538421` por el nuevo número (sin `+`, sin espacios).
...
```ts
case "CALL":
  window.open("https://wa.me/529994538421", "_blank");
```
...
México: `52` + 10 dígitos = 12 dígitos totales. Ejemplo: `529994538421`
